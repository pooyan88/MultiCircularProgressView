...
extension MultiCircularProgressView {
    ...
    private func setupRemainRingLayer(total: Double, remain: Double, strokeColor: UIColor) {
        ...
        let path = UIBezierPath(arcCenter: contentView.center, radius: bounds.width / 2, startAngle: getDegree(input: 0), endAngle: getDegree(input: getRemainPercentageDegree(total: total, remain: remain)), clockwise: true)
    ...
    private func setupBackgroundRing() {
        ...
        let path = UIBezierPath(arcCenter: contentView.center, radius: bounds.width / 2, startAngle: getDegree(input: 0), endAngle: getDegree(input: 360), clockwise: true)
